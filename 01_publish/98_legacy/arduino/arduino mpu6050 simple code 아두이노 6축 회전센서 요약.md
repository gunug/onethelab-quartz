---
layout: post
title: arduino mpu6050 simple code 아두이노 6축 회전센서 요약
category: arduino
tags: simple-code
---
...
```
* loop에서 delay를 잡으면 FIFO overflow가 발생
* delay가 없어야 정상적으로 값을 반환
* 상기 프로젝트의 경우는 인터럽트 핀 번호가 5 ```#define INTERRUPT_PIN 5```
...
```
* 추후에 저전력 20byte 송수신 제한을 맞추기 위한 값 변형이 들어갔습니다.
* Unity내에서 역산으로 복원하여 사용합니다.
