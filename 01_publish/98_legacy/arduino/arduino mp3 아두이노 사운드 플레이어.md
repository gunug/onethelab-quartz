---
layout: post
title: arduino mp3 아두이노 사운드 플레이어
category: arduino
tags: arduino mp3 audio
---
...
// Below is only needed if not interrupt driven. Safe to remove if not using.
  ...
  delay(100);
if(analogRead(A0) <= 5 && now_play != 1){MP3player.stopTrack();MP3player.playTrack(1);now_play = 1;}
if(analogRead(A1) <= 5 && now_play != 2){MP3player.stopTrack();MP3player.playTrack(2);now_play = 2;}
if(analogRead(A2) <= 5 && now_play != 3){MP3player.stopTrack();MP3player.playTrack(3);now_play = 3;}
if(analogRead(A0) >= 800 && analogRead(A1) >= 800 && analogRead(A2) >= 800){MP3player.stopTrack();now_play = 99;}
if(analogRead(A3) <= 5){
