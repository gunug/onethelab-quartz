...
* [[2024년 학과 수칙 및 수업 진행 방식]]{:target="_blank"}
* [[생성형 AI를 활용한 교수 학습 운영방법 가이드라인|생성형 AI를 활용한 교수/학습 운영방법 가이드라인]]{:target="_blank"}

# 실습
* Unity3d 설치 (2022년 이후 LTS 버전, 이전년도 버전 문제 발생)
* [[Meta quest 설치 및 사용]]{:target="_blank"}
* [[Meta XR Project Setting (2024-09-05)|Meta XR Project Setting]]{:target="_blank"}

# 1주차 과제
* 개인별로 제출합니다.
* 2~3인 1조로 팀 만들기. (1인 불가), 팀이름, 팀원 명시
* 생성형 AI 사용내역 공유 링크 - ([[생성형 AI를 활용한 교수 학습 운영방법 가이드라인|생성형 AI를 활용한 교수/학습 운영방법 가이드라인]]{:target="_blank"} 참고)
...
# 2주차
* [[vr smart phone 가상현실 스마트폰]]{:target="_blank"}

# 2주차 수업진행
* 개인정보 보호 목적으로 기기를 공장초기화 합니다. 이후 내용은 1주차와 동일 합니다.
* [[meta quest factory reset 메타 퀘스트 공장 초기화]]{:target="_blank"}
* [[Meta quest 설치 및 사용]]{:target="_blank"}
* [[Meta XR Project Setting (2024-09-05)|Meta XR Project Setting]]{:target="_blank"}
* [[vr empty room 빈 가상공간 만들기]]{:target="_blank"}
...
![[20242_kaywon_physical_1.jpg]]
* 기본 생성된 큐브는 scale(크기 배율)이 1,1,1이며 1m * 1m * 1m에 해당합니다.
![[20242_kaywon_physical_2.jpg]]
...
![[20242_kaywon_physical_6.jpg]]

![[20242_kaywon_physical_7.jpg]]

* 화면에 큐브 배치시 카메라와의 거리에 따라서도 글씨 크기가 다르게 보일 수 있음

![[20242_kaywon_physical_8.jpg]]

# Sample 체험
![[20242_kaywon_physical_9.jpg]]
...
## bezier path creator
* [[Bezier Path Creator]]{:target="_blank"}

![[20242_kaywon_physical_12.jpg]]
...
* [[follower trigger 기능 만들기]]{:target="_blank"}
...
## 공간 오디오 구성
* [[unity audio clip 오디오 클립]]{:target="_blank"}
...
* [[unity export package 패키지 내보내기]]{:target="_blank"}
...
# 11주차
* [[unity sound trigger 특정 위치에서 소리 출력하기]]{:target="_blank"}
* [[unity random sound 무작위 소리출력]]{:target="_blank"}
* [[moving object 상하로 움직이는 오브젝트]]{:target="_blank"}
* [[trigger parent null 특정위치에서 부모연결하기, 끊기|trigger parent null 특정위치에서 부모연결 끊기]]{:target="_blank"}
...
![[20242_kaywon_physical_13.jpg]]
![[20242_kaywon_physical_14.jpg]]
![[20242_kaywon_physical_15.jpg]]
