...
* [[시장조사, 정보수집, 사례조사, 아이디어]]{:target="_blank"}

---

# 1주차

* [[오리엔테이션]]{:target="_blank"}
* [[전체 프로세스 및 당부사항]]{:target="_blank"}
...
* [[plan 기획 (SWOT, 3C, 벨류 메트릭스, 포지셔닝, 벤치마킹)|기획 (SWOT, 3C, 벨류 메트릭스, 포지셔닝, 벤치마킹)]]{:target="_blank"}
...
### 캡스톤 디자인 과제 신청서
* [[2023-2-kaywon-graduation__form_capstone.hwp]]
...
## 6주차 과제
* [[1차심사, 직무수행능력평가1 준비|1차 직무수행능력평가]]
* 1차 직무수행능력평가 제출
* 우선 카페에 10월 16일 23:59:59 까지 제출합니다.
* 파일명 : 6주차_졸업작품심사_초안_이름_이름_이름_이름


### 7주차 진행예정
* 1차 심사 발표 없습니다. 5주차 과제(카페) 별도 제출하여 6주차 수업에 보도록 하겠습니다.
* 10월 17일 오후 9시까지 졸업작품심사(1차) 자료 수정하여 업로드
* [2023학년도 졸업작품심사(1차)](https://drive.google.com/drive/folders/1K1Yjk7375wC0KCo6MN00DQf0lB0MCC5A?usp=sharing)
* 구글 드라이브에 '번호_팀명_팀원이름' 폴더 만들어서 제출

## 1차 심사
* 그동안 제작한 내용을 정리하고, 관련 없는 내용 (이전 아이디어등)을 삭제합니다.
* 우리 프로젝트에 대해 아무것도 모르는 사람에게 설명한다는 생각으로 개요, 발단, 컨셉 등등을 설명할 수 있는 시각자료(글, 그림)들을 준비합니다.
* 분량을 늘리는데 너무 집중하면 전달해야 할 내용이 무엇인지 혼동만 야기할 수 있습니다. 
* 필요없는 내용(덜 중요한 내용)을 덜어내는 것도 필요합니다.
* 발표용 PDF에 긴 글로 적지 않도록 합니다. (핵심 단어들을 강조하고 부연 설명은 삭제)

### 필수로 포함할 것
* 프로젝트 선정이유 (디지털트렌드, 사회문제 등 여러가지 이유가 있을 것입니다)
* 프로젝트 제목
* 아이디어 선정, 한마디로 표현
* 정보구조도 (뉴미디어라면 컨텐츠 흐름도)
* 와이어 프레임 (뉴미디어라면 콘티)
* 디자인 컨셉
* 톤앤매너
* 컬러코드가 포함된 색상 선정
* 톤앤매너와 컬러코드가 적용된 실제 화면 이미지 2~3개
* 실제 작업된 작업물의 스크린샷 (중간과정)

### 포함되면 좋은 것
* 브레인스토밍(마인드맵,포스트업),SWOT분석, 페르소나 모형, 인터뷰, 설문조사
* 디지털 콘텐츠(앱, 웹, VR) 구동 프로토타입 또는 영상

# 1차심사 - 직무수행능력평가1
* 2차 심사(졸업심사의 본심)의 예행연습, 중간평가의 역할을 합니다.
* 팀원들끼리 상의하여 1차 심사에 전달해야하는 정보의 종류와 전달하는 방법/수단을 고려하여보고, 1차심사 후 여러분이 준비한 발표자료가 어떤효과가 있는지를 직접 확인할 수 있습니다.

### 제출방법
* 파일명 : 1차심사발표자료_팀명_이름_이름_이름_이름.pdf
* 파일명 : 1차심사발표대본_팀명_이름_이름_이름_이름.txt(확장자 주의)****
---

* 1차 심사와는 별개로 제작은 계속 진행되어야 다음 6주차 수업때 피드백 시간을 갖을 수 있습니다.
...
* 파일명 : 8주차_진행상황_이름_이름_이름_이름

---

# 1차 심사 결과
* 심사 점수는 공개하지 않습니다. (각 팀별 비교 문제, 본심전에 분위기가 안좋아 지는 문제 등)
## 노캔 히어로
* 우수 분야 : 정보수집 및 환경분석
* 미흡 분야 : 와이어 프레임, 스토리보드
* 차별화된 주제선정과 근거를 찾는 사용자 조사와 시나리오가 좋았음. VR 영상콘텐츠라 졸업작품 전시 당시 기대가 됨
## 학도
* 우수 분야 : 디자인 콘셉트 수립 및 시각화
* 미흡 분야 : 디자인 프로토타입
* 주제선정과 소재가 흥미로웠음. 스토리와 설계의 디테일이 아쉬움. 참고 영상이 없어서 아쉽지만 VR 영상 콘텐츠라 졸업작품 전시 시청시 좋은 경험을 줄수 있을것 같음
## InPrism
* 우수 분야 : 사용자 정의
* 미흡 분야 : 디자인 프로토타입
* 감정에 대한 콘텐츠를 뉴미디와 결합한 아이디어가 좋았음. 결과물이 완전하지 않지만 졸업작품 전시때 가장 먼저 체험해보고 싶음
## Timeout
* 우수 분야 : 와이어프레임 스토리보드
* 미흡 분야 : 정소수집 및 환경분석
* 전체적으로 컨셉에 대한 디테일이 아쉬움. 게임 시나리오와 디자인 결과물로 컨셉을 구체화 하여 좋았음. 컨셉영상이 없어서 완성도가 부족해보임 
...
## 캡스톤 디자인 최종보고서 및 설문조사
* [[2023-2-kaywon-graduation__2023_capstone.zip]]

### [디지털미디어디자인과] 캡스톤디자인 최종보고서_2PS4_팀명
* 팀별 1부 작성 [[2023-2-kaywon-graduation__capstone_report.docx]]
* 교과명 : 졸업작품 스튜디오
* 지도교수 : 조건희 교수 (교수님 x)
* 과제유형 : 전공역량형
* 과제 수행인원 안의 지도교수는 이름만 적으면 됩니다. (교수 x)
* 과제 지도 일지 [지도교수] - 아래의 예시를 보고 2023년 실제 수업날짜에 맞추어 작성, 지도내용은 교안의 첫문장 (예: 3주차 - SWOT Matrix, 3C, 밸류 매트릭스, 포지셔닝, 벤치마킹 보완)

![[2023-2-kaywon-graduation_1.png]]

* 지도교수 서명 : 카카오톡 단독방에서 확인

### [디지털미디어디자인과] 참여학생 설문조사서_2PS4_팀명
...
## 티저영상
* [https://www.youtube.com/embed/rp0M5Y6JMbQ?si=7SwVVjzZGx-mUYwW](https://www.youtube.com/embed/rp0M5Y6JMbQ?si=7SwVVjzZGx-mUYwW)
