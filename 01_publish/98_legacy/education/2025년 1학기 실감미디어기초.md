...
* [[2025년 학과 수칙 및 수업 진행 방식]]{:target="_blank"}
...
### 수업
* [[Unity install 유니티 설치]]{:target="_blank"}
* [[Unity license 유니티 라이센스 취득|Unity license 유니티 라이센스 취득 ]]{:target="_blank"}
* [[Unity 2D project 유니티 2D 프로젝트 만들기]]{:target="_blank"}

### 과제
* 위 내용을 바탕으로 Unity 설치, 라이센스 취득, 새 2D 프로젝트 만들기를 진행합니다.
  
![[kaywon_education_1.jpg]]
...
## 2주차
### 수업
* [[unity layout setting 유니티 레이아웃 설정]]{:target="_blank"}
* [[unity 각 창의 명칭과 기능]]{:target="_blank"}
* [[unity sprite 스프라이트]]{:target="_blank"}
* [[unity sprite position 스프라이트 위치 변경|unity sprite position 스프라이트 위치 변경 ]]{:target="_blank"}
* [[unity 2d animation 애니메이션]]{:target="_blank"}
...
![[kaywon_education_2.jpg]]
![[kaywon_education_3.jpg]]
...
## 3주차
### 수업
* [[unity 2d animator 애니메이터]]{:target="_blank"}
* [[unity 2d button 버튼]]{:target="_blank"}
* [[programming 프로그래밍 언어를 배우는 이유]]{:target="_blank"}
* 이론수업을 하면서 유의사항 : 이해도를 높이기 위한 수업입니다. 이 내용으로 시험을 보거나 점수를 매기지 않습니다. 이해도가 높을수록 프로그래밍이 재밌어집니다.
* [[literal object constant variable 리터럴 객체 상수 변수|literal constant variable 리터럴 상수 변수]]{:target="_blank"}
...
## 4주차
### 수업
* [[unity visual studio code 비쥬얼 스튜디오 코드 연결]]{:target="_blank"}
* [[unity image gallery 이미지 갤러리 만들기]]{:target="_blank"}
...
### 수업
* [[변수]]{:target="_blank"}
* [[unity video player 비디오 플레이어]]{:target="_blank"}
...
## 6주차
### 수업
* [[unity scene manager 장면이동]]{:target="_blank"}
...
## 8주차 - 중간평가
* [[2025년 1학기 실감미디어기초 - 중간평가]]{:target="_blank"}

---

## 9주차
### 수업
* [[Unity 새 3D project 만들기]]{:target="_blank"}
...
## 10주차
### 수업
* [[Unity Camera Control 카메라 제어]]{:target="_blank"}
### 과제
...
### 수업
* [[Unity humanoid animation 휴머노이드 에니메이션]]{:target="_blank"}
* [[Unity Probuilder 프로빌더]]{:target="_blank"}
* [[Unity Drag Object 드래그]]{:target="_blank"}
...
* B,C반 : 2025-06-13
* A반 : 2025-06-16
* [[2025년 1학기 실감미디어기초 - 기말평가]]{:target="_blank"}
