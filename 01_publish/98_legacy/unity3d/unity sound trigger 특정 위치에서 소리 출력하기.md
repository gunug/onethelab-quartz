...
```
![[unity_sound_trigger_4.jpg]]
* 작성된 스크립트를 cube에 드래그 드랍하여 전달

![[unity_sound_trigger_5.jpg]]
* cube에 mp3파일을 드래그 드랍
* AudioSource componant가 자동으로 생성됨

![[unity_sound_trigger_6.jpg]]
