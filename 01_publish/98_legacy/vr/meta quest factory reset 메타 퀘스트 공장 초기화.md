...
## 기기를 완전히 종료
![[meta_quest_factory_reset_1.jpg]]
* 전원 버튼을 누른 후 컨트롤러를 이용하여 종료
* 컨트롤러를 사용할 수 없는경우 전원 버튼을 20초간 길게 누르면 VR헤드셋이 강제종료됨

## 전원키와 볼륨 다운(-)키 누르기
![[meta_quest_factory_reset_2.jpg]]
* Meta 로고가 나타날 때까지 누르고 있기

![[meta_quest_factory_reset_3.jpg]]
* Meta 로고가 나타나면 버튼에서 손 때기

![[meta_quest_factory_reset_4.jpg]]
* Factory reset 공장 초기화 선택
* +, - 버튼으로 메뉴 이동. 전원 버튼으로 선택

![[meta_quest_factory_reset_5.jpg]]
* 재 확인 절차에서 yes 선택
* 기다리기

![[meta_quest_factory_reset_6.jpg]]
