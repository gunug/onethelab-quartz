...
* 이 실습은 [[Meta XR Project Setting (2024-09-05)|Meta XR Project Setting]]{:target="_blank"} 이 선행 되어야 합니다.
...
# 스크립트 생성하기
* 기존 [[Gemini 제미나이 실습2]]{:target="_blank"}을 통해 만들어진 소스코드를 그대로 사용하여 다른 이벤트에 연결해 봅시다.
