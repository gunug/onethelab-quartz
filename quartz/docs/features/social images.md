...
After enabling the [[quartz/docs/plugins/CustomOgImages]] emitter plugin, the social media link preview for [[authoring content | Authoring Content]] looks like this:
...
This functionality is provided by the [[quartz/docs/plugins/CustomOgImages]] plugin. See the plugin page for customization options.
